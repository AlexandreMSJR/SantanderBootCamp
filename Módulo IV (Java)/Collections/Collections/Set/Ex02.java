...
public class Ex02 {
    ...
    public static void main(String[] args) {
        ...
        minhasLinguagensFavoritas.add(new LinguagemFavorita("JS", 1990, "VS"));
        minhasLinguagensFavoritas.add(new LinguagemFavorita("Angular", 2009, "VS"));
        ...
        Set<LinguagemFavorita> minhasLinguagensFavoritas1 = new LinkedHashSet<>(
                Arrays.asList(
                        new LinguagemFavorita("JS", 1990, "VS"),
                        new LinguagemFavorita("Angular", 2009, "VS"),
